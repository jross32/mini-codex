---
name: promotion-gate-plugin-interface
description: "Use when implementing or improving promotion-gate-plugin-interface workflows in mini-codex."
argument-hint: "Describe the goal, target files, constraints, and validation expectations"
user-invocable: true
---

# promotion-gate-plugin-interface

## Purpose
- Define pluggable gate interfaces for extension without core edits.
