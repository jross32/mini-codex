---
name: worker-budget-enforcer
description: "Use when implementing or improving worker-budget-enforcer workflows in mini-codex."
argument-hint: "Describe the goal, target files, constraints, and validation expectations"
user-invocable: true
---

# worker-budget-enforcer

## Purpose
- Apply per-worker budgets for time, spawns, and resource usage.
