---
name: config-diff-reporter
description: "Use when implementing or improving config-diff-reporter workflows in mini-codex."
argument-hint: "Describe the goal, target files, constraints, and validation expectations"
user-invocable: true
---

# config-diff-reporter

## Purpose
- Report config differences between key execution windows.
