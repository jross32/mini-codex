---
name: candidate-degradation-detector
description: "Use when implementing or improving candidate-degradation-detector workflows in mini-codex."
argument-hint: "Describe the goal, target files, constraints, and validation expectations"
user-invocable: true
---

# candidate-degradation-detector

## Purpose
- Detect repeated runtime degradation after candidate activation.
