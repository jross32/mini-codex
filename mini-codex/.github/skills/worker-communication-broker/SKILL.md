---
name: worker-communication-broker
description: "Use when implementing or improving worker-communication-broker workflows in mini-codex."
argument-hint: "Describe the goal, target files, constraints, and validation expectations"
user-invocable: true
---

# worker-communication-broker

## Purpose
- Coordinate workers by sharing intermediate findings and constraints.
