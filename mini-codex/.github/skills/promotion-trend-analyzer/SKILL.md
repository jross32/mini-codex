---
name: promotion-trend-analyzer
description: "Use when implementing or improving promotion-trend-analyzer workflows in mini-codex."
argument-hint: "Describe the goal, target files, constraints, and validation expectations"
user-invocable: true
---

# promotion-trend-analyzer

## Purpose
- Compare current candidate metrics against historical promotion trends.
