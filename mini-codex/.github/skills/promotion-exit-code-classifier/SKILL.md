---
name: promotion-exit-code-classifier
description: "Use when implementing or improving promotion-exit-code-classifier workflows in mini-codex."
argument-hint: "Describe the goal, target files, constraints, and validation expectations"
user-invocable: true
---

# promotion-exit-code-classifier

## Purpose
- Classify promotion outcomes into rejection vs execution failure with explicit exit semantics.
