---
name: test-select-stub-implementer
description: "Use when implementing or improving test-select-stub-implementer workflows in mini-codex."
argument-hint: "Describe the goal, target files, constraints, and validation expectations"
user-invocable: true
---

# test-select-stub-implementer

## Purpose
- Implement scoring logic for test_select follow-up ranking.
