---
name: promotion-ambient-gate
description: "Use when implementing or improving promotion-ambient-gate workflows in mini-codex."
argument-hint: "Describe the goal, target files, constraints, and validation expectations"
user-invocable: true
---

# promotion-ambient-gate

## Purpose
- Delay promotion when ambient context diverges from baseline assumptions.
