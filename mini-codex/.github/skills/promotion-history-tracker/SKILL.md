---
name: promotion-history-tracker
description: "Use when implementing or improving promotion-history-tracker workflows in mini-codex."
argument-hint: "Describe the goal, target files, constraints, and validation expectations"
user-invocable: true
---

# promotion-history-tracker

## Purpose
- Maintain rolling snapshot history with metadata for recent promotions.
