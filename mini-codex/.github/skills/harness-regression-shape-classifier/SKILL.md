---
name: harness-regression-shape-classifier
description: "Use when implementing or improving harness-regression-shape-classifier workflows in mini-codex."
argument-hint: "Describe the goal, target files, constraints, and validation expectations"
user-invocable: true
---

# harness-regression-shape-classifier

## Purpose
- Classify benchmark regression patterns by shape.
