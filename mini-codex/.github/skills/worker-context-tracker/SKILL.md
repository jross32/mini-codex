---
name: worker-context-tracker
description: "Use when implementing or improving worker-context-tracker workflows in mini-codex."
argument-hint: "Describe the goal, target files, constraints, and validation expectations"
user-invocable: true
---

# worker-context-tracker

## Purpose
- Track per-worker ambient context for diagnostics and policy decisions.
