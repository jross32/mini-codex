---
name: evaluator-metric-plugin
description: "Use when implementing or improving evaluator-metric-plugin workflows in mini-codex."
argument-hint: "Describe the goal, target files, constraints, and validation expectations"
user-invocable: true
---

# evaluator-metric-plugin

## Purpose
- Allow custom evaluation metrics beyond built-in scores.
