---
name: agent-run-replay-system
description: "Use when implementing or improving agent-run-replay-system workflows in mini-codex."
argument-hint: "Describe the goal, target files, constraints, and validation expectations"
user-invocable: true
---

# agent-run-replay-system

## Purpose
- Replay historical runs for diagnosis and regression analysis.
