---
name: harness-percentile-calculator
description: "Use when implementing or improving harness-percentile-calculator workflows in mini-codex."
argument-hint: "Describe the goal, target files, constraints, and validation expectations"
user-invocable: true
---

# harness-percentile-calculator

## Purpose
- Calculate percentile distributions for benchmark latency.
