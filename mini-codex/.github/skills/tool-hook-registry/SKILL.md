---
name: tool-hook-registry
description: "Use when implementing or improving tool-hook-registry workflows in mini-codex."
...
## Purpose
- Register pre/post tool hooks for validation and logging.
