---
name: promotion-gates-schema-validator
description: "Use when implementing or improving promotion-gates-schema-validator workflows in mini-codex."
argument-hint: "Describe the goal, target files, constraints, and validation expectations"
user-invocable: true
---

# promotion-gates-schema-validator

## Purpose
- Validate promotion_gates.json structure and constraints.
