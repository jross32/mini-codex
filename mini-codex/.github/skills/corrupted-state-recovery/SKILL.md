...
description: "Use when implementing or improving corrupted-state-recovery workflows in mini-codex."
...
## Purpose
- Repair corrupted state logs and rebuild minimal valid state.
