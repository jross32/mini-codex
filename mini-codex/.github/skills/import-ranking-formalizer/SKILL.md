---
name: import-ranking-formalizer
description: "Use when implementing or improving import-ranking-formalizer workflows in mini-codex."
argument-hint: "Describe the goal, target files, constraints, and validation expectations"
user-invocable: true
---

# import-ranking-formalizer

## Purpose
- Define deterministic import-ranking logic for file prioritization.
