---
name: autonomous-worker-lifecycle-tracker
description: "Use when implementing or improving autonomous-worker-lifecycle-tracker workflows in mini-codex."
argument-hint: "Describe the goal, target files, constraints, and validation expectations"
user-invocable: true
---

# autonomous-worker-lifecycle-tracker

## Purpose
- Track autonomous worker lifecycle from spawn to completion.
