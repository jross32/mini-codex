---
name: harness-cross-repo-analyzer
description: "Use when implementing or improving harness-cross-repo-analyzer workflows in mini-codex."
argument-hint: "Describe the goal, target files, constraints, and validation expectations"
user-invocable: true
---

# harness-cross-repo-analyzer

## Purpose
- Aggregate benchmark results across multiple repositories.
