---
name: orchestrator-resource-monitor
description: "Use when implementing or improving orchestrator-resource-monitor workflows in mini-codex."
argument-hint: "Describe the goal, target files, constraints, and validation expectations"
user-invocable: true
---

# orchestrator-resource-monitor

## Purpose
- Track worker CPU and memory use with safety thresholds.
