---
name: orchestrator-phasing-timer
description: "Use when implementing or improving orchestrator-phasing-timer workflows in mini-codex."
argument-hint: "Describe the goal, target files, constraints, and validation expectations"
user-invocable: true
---

# orchestrator-phasing-timer

## Purpose
- Measure and report time spent in each orchestration phase.
