---
name: gate-config-schema
description: "Use when implementing or improving gate-config-schema workflows in mini-codex."
...
## Purpose
- Define and validate schema for promotion gate configuration.
