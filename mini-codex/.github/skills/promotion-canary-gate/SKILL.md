---
name: promotion-canary-gate
description: "Use when implementing or improving promotion-canary-gate workflows in mini-codex."
argument-hint: "Describe the goal, target files, constraints, and validation expectations"
user-invocable: true
---

# promotion-canary-gate

## Purpose
- Run candidate tools on canary samples before full promotion.
