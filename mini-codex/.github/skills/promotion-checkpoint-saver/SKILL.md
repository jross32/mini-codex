---
name: promotion-checkpoint-saver
description: "Use when implementing or improving promotion-checkpoint-saver workflows in mini-codex."
argument-hint: "Describe the goal, target files, constraints, and validation expectations"
user-invocable: true
---

# promotion-checkpoint-saver

## Purpose
- Persist partial promotion checkpoints so interrupted runs can resume.
