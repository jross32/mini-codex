---
name: environmental-gate-engine
description: "Use when implementing or improving environmental-gate-engine workflows in mini-codex."
argument-hint: "Describe the goal, target files, constraints, and validation expectations"
user-invocable: true
---

# environmental-gate-engine

## Purpose
- Compose promotion gates from runtime environment predicates.
