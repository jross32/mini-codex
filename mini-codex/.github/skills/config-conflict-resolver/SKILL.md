---
name: config-conflict-resolver
description: "Use when implementing or improving config-conflict-resolver workflows in mini-codex."
argument-hint: "Describe the goal, target files, constraints, and validation expectations"
user-invocable: true
---

# config-conflict-resolver

## Purpose
- Detect and resolve conflicting config sources.
