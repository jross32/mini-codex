---
name: orchestrator-failure-mode-categorizer
description: "Use when implementing or improving orchestrator-failure-mode-categorizer workflows in mini-codex."
argument-hint: "Describe the goal, target files, constraints, and validation expectations"
user-invocable: true
---

# orchestrator-failure-mode-categorizer

## Purpose
- Categorize worker failures for triage and retry strategy.
