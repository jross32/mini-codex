---
name: semantic-file-ranker
description: "Use when implementing or improving semantic-file-ranker workflows in mini-codex."
...
## Purpose
- Rank candidate files by semantic relevance to the current goal.
