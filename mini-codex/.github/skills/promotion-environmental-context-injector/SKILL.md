---
name: promotion-environmental-context-injector
description: "Use when implementing or improving promotion-environmental-context-injector workflows in mini-codex."
argument-hint: "Describe the goal, target files, constraints, and validation expectations"
user-invocable: true
---

# promotion-environmental-context-injector

## Purpose
- Capture repo and runtime context during promotion evaluation.
