---
name: trust-threshold-tuner
description: "Use when implementing or improving trust-threshold-tuner workflows in mini-codex."
argument-hint: "Describe the goal, target files, constraints, and validation expectations"
user-invocable: true
---

# trust-threshold-tuner

## Purpose
- Tune trust thresholds using observed worker outcomes and stability.
