---
name: promotion-run-timeline-visualizer
description: "Use when implementing or improving promotion-run-timeline-visualizer workflows in mini-codex."
argument-hint: "Describe the goal, target files, constraints, and validation expectations"
user-invocable: true
---

# promotion-run-timeline-visualizer

## Purpose
- Generate timeline artifacts for promotion phase durations.
