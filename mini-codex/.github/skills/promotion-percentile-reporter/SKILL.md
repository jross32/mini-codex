---
name: promotion-percentile-reporter
description: "Use when implementing or improving promotion-percentile-reporter workflows in mini-codex."
argument-hint: "Describe the goal, target files, constraints, and validation expectations"
user-invocable: true
---

# promotion-percentile-reporter

## Purpose
- Emit p50, p95, and p99 timing metrics in promotion reports.
