---
name: config-rollback-manager
description: "Use when implementing or improving config-rollback-manager workflows in mini-codex."
...
## Purpose
- Rollback config versions when new settings destabilize outcomes.
