---
name: orchestrator-event-stream-publisher
description: "Use when implementing or improving orchestrator-event-stream-publisher workflows in mini-codex."
argument-hint: "Describe the goal, target files, constraints, and validation expectations"
user-invocable: true
---

# orchestrator-event-stream-publisher

## Purpose
- Publish worker lifecycle events to stream consumers.
