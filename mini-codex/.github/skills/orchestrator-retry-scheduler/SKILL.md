---
name: orchestrator-retry-scheduler
description: "Use when implementing or improving orchestrator-retry-scheduler workflows in mini-codex."
argument-hint: "Describe the goal, target files, constraints, and validation expectations"
user-invocable: true
---

# orchestrator-retry-scheduler

## Purpose
- Retry eligible failures with bounded backoff policy.
