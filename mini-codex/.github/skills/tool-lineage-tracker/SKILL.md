---
name: tool-lineage-tracker
description: "Use when implementing or improving tool-lineage-tracker workflows in mini-codex."
argument-hint: "Describe the goal, target files, constraints, and validation expectations"
user-invocable: true
---

# tool-lineage-tracker

## Purpose
- Track lineage between generated tool variants and parents.
