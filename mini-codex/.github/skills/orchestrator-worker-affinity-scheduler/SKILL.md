---
name: orchestrator-worker-affinity-scheduler
description: "Use when implementing or improving orchestrator-worker-affinity-scheduler workflows in mini-codex."
argument-hint: "Describe the goal, target files, constraints, and validation expectations"
user-invocable: true
---

# orchestrator-worker-affinity-scheduler

## Purpose
- Schedule workers by affinity for locality and cache benefit.
