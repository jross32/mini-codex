---
name: threshold-environment-scoper
description: "Use when implementing or improving threshold-environment-scoper workflows in mini-codex."
argument-hint: "Describe the goal, target files, constraints, and validation expectations"
user-invocable: true
---

# threshold-environment-scoper

## Purpose
- Apply gate thresholds by environment size and risk class.
