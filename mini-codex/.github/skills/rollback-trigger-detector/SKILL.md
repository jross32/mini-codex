---
name: rollback-trigger-detector
description: "Use when implementing or improving rollback-trigger-detector workflows in mini-codex."
argument-hint: "Describe the goal, target files, constraints, and validation expectations"
user-invocable: true
---

# rollback-trigger-detector

## Purpose
- Detect rollback-worthy failure bursts from runtime telemetry.
