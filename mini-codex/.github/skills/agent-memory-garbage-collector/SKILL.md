---
name: agent-memory-garbage-collector
description: "Use when implementing or improving agent-memory-garbage-collector workflows in mini-codex."
...
## Purpose
- Prune stale memory artifacts while preserving critical context.
