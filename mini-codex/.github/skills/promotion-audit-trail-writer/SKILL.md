---
name: promotion-audit-trail-writer
description: "Use when implementing or improving promotion-audit-trail-writer workflows in mini-codex."
argument-hint: "Describe the goal, target files, constraints, and validation expectations"
user-invocable: true
---

# promotion-audit-trail-writer

## Purpose
- Append structured decision logs for every promotion attempt.
