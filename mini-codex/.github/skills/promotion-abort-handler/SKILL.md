---
name: promotion-abort-handler
description: "Use when implementing or improving promotion-abort-handler workflows in mini-codex."
argument-hint: "Describe the goal, target files, constraints, and validation expectations"
user-invocable: true
---

# promotion-abort-handler

## Purpose
- Handle user-initiated promotion aborts with safe checkpointing.
