---
name: harness-noise-estimator
description: "Use when implementing or improving harness-noise-estimator workflows in mini-codex."
argument-hint: "Describe the goal, target files, constraints, and validation expectations"
user-invocable: true
---

# harness-noise-estimator

## Purpose
- Estimate measurement noise and significance thresholds.
