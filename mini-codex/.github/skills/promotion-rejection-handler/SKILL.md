---
name: promotion-rejection-handler
description: "Use when implementing or improving promotion-rejection-handler workflows in mini-codex."
argument-hint: "Describe the goal, target files, constraints, and validation expectations"
user-invocable: true
---

# promotion-rejection-handler

## Purpose
- Record gate failures with actionable reasons and stop unsafe promotions.
