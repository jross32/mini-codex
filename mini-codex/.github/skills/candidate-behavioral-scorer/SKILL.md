---
name: candidate-behavioral-scorer
description: "Use when implementing or improving candidate-behavioral-scorer workflows in mini-codex."
argument-hint: "Describe the goal, target files, constraints, and validation expectations"
user-invocable: true
---

# candidate-behavioral-scorer

## Purpose
- Score behavioral changes beyond latency, including error profile deltas.
