---
name: state-snapshot-compressor
description: "Use when implementing or improving state-snapshot-compressor workflows in mini-codex."
argument-hint: "Describe the goal, target files, constraints, and validation expectations"
user-invocable: true
---

# state-snapshot-compressor

## Purpose
- Compress repeated state payload data in logs.
