---
name: tool-classification-enforcer
description: "Use when implementing or improving tool-classification-enforcer workflows in mini-codex."
argument-hint: "Describe the goal, target files, constraints, and validation expectations"
user-invocable: true
---

# tool-classification-enforcer

## Purpose
- Validate tool taxonomy and category constraints at registration.
