---
name: state-recovery-reconstructor
description: "Use when implementing or improving state-recovery-reconstructor workflows in mini-codex."
argument-hint: "Describe the goal, target files, constraints, and validation expectations"
user-invocable: true
---

# state-recovery-reconstructor

## Purpose
- Reconstruct agent state from partial or damaged logs.
