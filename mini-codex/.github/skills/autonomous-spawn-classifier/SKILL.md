---
name: autonomous-spawn-classifier
description: "Use when implementing or improving autonomous-spawn-classifier workflows in mini-codex."
argument-hint: "Describe the goal, target files, constraints, and validation expectations"
user-invocable: true
---

# autonomous-spawn-classifier

## Purpose
- Record and classify each autonomous spawn decision with rationale.
