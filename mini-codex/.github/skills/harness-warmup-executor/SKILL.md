---
name: harness-warmup-executor
description: "Use when implementing or improving harness-warmup-executor workflows in mini-codex."
argument-hint: "Describe the goal, target files, constraints, and validation expectations"
user-invocable: true
---

# harness-warmup-executor

## Purpose
- Run warmup iterations before benchmark measurements.
