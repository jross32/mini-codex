---
name: planner-intent-extension
description: "Use when implementing or improving planner-intent-extension workflows in mini-codex."
argument-hint: "Describe the goal, target files, constraints, and validation expectations"
user-invocable: true
---

# planner-intent-extension

## Purpose
- Extend planner intent mappings with configurable rules.
