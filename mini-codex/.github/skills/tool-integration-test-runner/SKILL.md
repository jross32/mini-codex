---
name: tool-integration-test-runner
description: "Use when implementing or improving tool-integration-test-runner workflows in mini-codex."
...
## Purpose
- Execute integration checks for tools in realistic agent-loop flows.
