...
description: "Use when implementing or improving large-file-splitter workflows in mini-codex."
...
## Purpose
- Chunk large files for incremental analysis and safer memory usage.
