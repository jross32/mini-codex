---
name: harness-outlier-detector
description: "Use when implementing or improving harness-outlier-detector workflows in mini-codex."
argument-hint: "Describe the goal, target files, constraints, and validation expectations"
user-invocable: true
---

# harness-outlier-detector

## Purpose
- Detect and flag statistical outliers in benchmark runs.
