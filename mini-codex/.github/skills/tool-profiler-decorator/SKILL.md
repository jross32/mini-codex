---
name: tool-profiler-decorator
description: "Use when implementing or improving tool-profiler-decorator workflows in mini-codex."
argument-hint: "Describe the goal, target files, constraints, and validation expectations"
user-invocable: true
---

# tool-profiler-decorator

## Purpose
- Instrument tools for wall-time, CPU, and memory profiling.
