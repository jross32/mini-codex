---
name: venv-leak-detector
description: "Use when implementing or improving venv-leak-detector workflows in mini-codex."
...
## Purpose
- Detect and suppress virtual-environment leakage in repository analysis.
