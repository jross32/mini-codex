---
name: quality-gate-deterministic-enforcer
description: "Use when implementing or improving quality-gate-deterministic-enforcer workflows in mini-codex."
argument-hint: "Describe the goal, target files, constraints, and validation expectations"
user-invocable: true
---

# quality-gate-deterministic-enforcer

## Purpose
- Enforce deterministic quality gate tool execution order.
