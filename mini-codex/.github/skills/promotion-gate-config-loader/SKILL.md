---
name: promotion-gate-config-loader
description: "Use when implementing or improving promotion-gate-config-loader workflows in mini-codex."
argument-hint: "Describe the goal, target files, constraints, and validation expectations"
user-invocable: true
---

# promotion-gate-config-loader

## Purpose
- Load per-tool threshold tuning from promotion_gates.json with validation.
