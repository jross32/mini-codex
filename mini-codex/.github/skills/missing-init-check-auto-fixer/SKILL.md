---
name: missing-init-check-auto-fixer
description: "Use when implementing or improving missing-init-check-auto-fixer workflows in mini-codex."
argument-hint: "Describe the goal, target files, constraints, and validation expectations"
user-invocable: true
---

# missing-init-check-auto-fixer

## Purpose
- Auto-fix missing package init files detected by health checks.
