---
name: orchestrator-resource-pooling
description: "Use when implementing or improving orchestrator-resource-pooling workflows in mini-codex."
argument-hint: "Describe the goal, target files, constraints, and validation expectations"
user-invocable: true
---

# orchestrator-resource-pooling

## Purpose
- Reuse shared outputs across workers to reduce duplicate work.
