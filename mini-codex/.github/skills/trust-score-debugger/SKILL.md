---
name: trust-score-debugger
description: "Use when implementing or improving trust-score-debugger workflows in mini-codex."
argument-hint: "Describe the goal, target files, constraints, and validation expectations"
user-invocable: true
---

# trust-score-debugger

## Purpose
- Explain trust score composition and contribution of each signal.
