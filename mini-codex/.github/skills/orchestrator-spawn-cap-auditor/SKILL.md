---
name: orchestrator-spawn-cap-auditor
description: "Use when implementing or improving orchestrator-spawn-cap-auditor workflows in mini-codex."
argument-hint: "Describe the goal, target files, constraints, and validation expectations"
user-invocable: true
---

# orchestrator-spawn-cap-auditor

## Purpose
- Audit spawn behavior relative to max worker constraints.
