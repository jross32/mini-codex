---
name: artifact-processor-chain
description: "Use when implementing or improving artifact-processor-chain workflows in mini-codex."
argument-hint: "Describe the goal, target files, constraints, and validation expectations"
user-invocable: true
---

# artifact-processor-chain

## Purpose
- Chain artifact post-processing steps in a controlled pipeline.
