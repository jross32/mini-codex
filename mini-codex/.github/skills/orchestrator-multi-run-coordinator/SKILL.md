---
name: orchestrator-multi-run-coordinator
description: "Use when implementing or improving orchestrator-multi-run-coordinator workflows in mini-codex."
argument-hint: "Describe the goal, target files, constraints, and validation expectations"
user-invocable: true
---

# orchestrator-multi-run-coordinator

## Purpose
- Coordinate orchestrations across multiple repos in sequence.
