---
name: orchestrator-graceful-shutdown
description: "Use when implementing or improving orchestrator-graceful-shutdown workflows in mini-codex."
...
## Purpose
- Persist state and shutdown cleanly on interruption.
