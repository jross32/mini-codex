---
name: tool-improver-behavioral-scorer
description: "Use when implementing or improving tool-improver-behavioral-scorer workflows in mini-codex."
argument-hint: "Describe the goal, target files, constraints, and validation expectations"
user-invocable: true
---

# tool-improver-behavioral-scorer

## Purpose
- Score tool improvements by behavior and robustness changes.
