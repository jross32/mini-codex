---
name: follow-up-context-limiter
description: "Use when implementing or improving follow-up-context-limiter workflows in mini-codex."
argument-hint: "Describe the goal, target files, constraints, and validation expectations"
user-invocable: true
---

# follow-up-context-limiter

## Purpose
- Set dynamic follow-up read limits based on task intent.
