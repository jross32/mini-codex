---
name: agent-loop-performance-bottleneck-detector
description: "Use when implementing or improving agent-loop-performance-bottleneck-detector workflows in mini-codex."
argument-hint: "Describe the goal, target files, constraints, and validation expectations"
user-invocable: true
---

# agent-loop-performance-bottleneck-detector

## Purpose
- Find bottlenecks in planning, execution, and evaluation phases.
