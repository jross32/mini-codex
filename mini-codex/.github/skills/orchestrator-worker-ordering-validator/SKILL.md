---
name: orchestrator-worker-ordering-validator
description: "Use when implementing or improving orchestrator-worker-ordering-validator workflows in mini-codex."
argument-hint: "Describe the goal, target files, constraints, and validation expectations"
user-invocable: true
---

# orchestrator-worker-ordering-validator

## Purpose
- Validate fixed worker phase ordering in orchestrator runs.
