---
name: promotion-pre-flight-validator
description: "Use when implementing or improving promotion-pre-flight-validator workflows in mini-codex."
argument-hint: "Describe the goal, target files, constraints, and validation expectations"
user-invocable: true
---

# promotion-pre-flight-validator

## Purpose
- Run syntax and import preflight checks before promotion.
