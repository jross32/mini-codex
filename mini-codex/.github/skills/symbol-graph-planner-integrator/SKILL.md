---
name: symbol-graph-planner-integrator
description: "Use when implementing or improving symbol-graph-planner-integrator workflows in mini-codex."
argument-hint: "Describe the goal, target files, constraints, and validation expectations"
user-invocable: true
---

# symbol-graph-planner-integrator

## Purpose
- Integrate symbol graph signals into planning decisions.
