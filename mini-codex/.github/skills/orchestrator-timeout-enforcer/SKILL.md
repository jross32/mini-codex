---
name: orchestrator-timeout-enforcer
description: "Use when implementing or improving orchestrator-timeout-enforcer workflows in mini-codex."
argument-hint: "Describe the goal, target files, constraints, and validation expectations"
user-invocable: true
---

# orchestrator-timeout-enforcer

## Purpose
- Apply end-to-end orchestration timeout controls.
