---
name: harness-historical-comparison
description: "Use when implementing or improving harness-historical-comparison workflows in mini-codex."
argument-hint: "Describe the goal, target files, constraints, and validation expectations"
user-invocable: true
---

# harness-historical-comparison

## Purpose
- Compare benchmark results against historical runs.
