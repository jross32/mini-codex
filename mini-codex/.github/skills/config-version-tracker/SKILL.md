---
name: config-version-tracker
description: "Use when implementing or improving config-version-tracker workflows in mini-codex."
...
## Purpose
- Track and audit configuration versions across runs.
