---
name: hierarchical-worker-spawner
description: "Use when implementing or improving hierarchical-worker-spawner workflows in mini-codex."
argument-hint: "Describe the goal, target files, constraints, and validation expectations"
user-invocable: true
---

# hierarchical-worker-spawner

## Purpose
- Support bounded child-worker spawning with guardrails.
