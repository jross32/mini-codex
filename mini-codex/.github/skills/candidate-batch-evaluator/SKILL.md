---
name: candidate-batch-evaluator
description: "Use when implementing or improving candidate-batch-evaluator workflows in mini-codex."
argument-hint: "Describe the goal, target files, constraints, and validation expectations"
user-invocable: true
---

# candidate-batch-evaluator

## Purpose
- Evaluate candidates across a diverse multi-repo benchmark set.
