---
name: auto-revert-executor
description: "Use when implementing or improving auto-revert-executor workflows in mini-codex."
argument-hint: "Describe the goal, target files, constraints, and validation expectations"
user-invocable: true
---

# auto-revert-executor

## Purpose
- Perform automatic temporary reversion to stable versions on failure.
