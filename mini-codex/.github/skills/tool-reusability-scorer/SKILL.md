---
name: tool-reusability-scorer
description: "Use when implementing or improving tool-reusability-scorer workflows in mini-codex."
argument-hint: "Describe the goal, target files, constraints, and validation expectations"
user-invocable: true
---

# tool-reusability-scorer

## Purpose
- Score branch and leaf reuse potential across generated tools.
