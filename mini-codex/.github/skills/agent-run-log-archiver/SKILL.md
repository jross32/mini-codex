---
name: agent-run-log-archiver
description: "Use when implementing or improving agent-run-log-archiver workflows in mini-codex."
argument-hint: "Describe the goal, target files, constraints, and validation expectations"
user-invocable: true
---

# agent-run-log-archiver

## Purpose
- Archive old run logs while preserving searchable indexes.
