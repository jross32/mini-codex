...
export function TeamRosterHub() {
  ...
  const teamsQuery = useQuery({
    queryKey: ["search-teams-hub", debounced],
    ...
    <div className="page-container">
      <div className="page">
        ...
        <div>
          ...
          <h1>Pick a team</h1>
          <p className="lede">Jump to a roster and match history.</p>
        </div>
      ...
      {teamsQuery.isSuccess && teams.length === 0 && (
        <EmptyState
          ...
          message="Search to pick a roster to manage."
          action={
      ...
      {teams.length === 0 && debounced.length <= 1 && !teamsQuery.isLoading && (
        <EmptyState
          ...
          message="Use a team name or division to jump in."
          action={
